...
class StorageManager {
    ...
    async saveBotFromJson(characterData, imageUrl) {
        ...
        const sanitizedCharacterData = {
            ...
            first_mes: characterData.first_mes || characterData.first_message || characterData.firstMessage || '',
            mes_example: characterData.mes_example || characterData.example_messages || characterData.exampleMessage || characterData.exampleDialogs || '',
